...
const Header: React.FC = () => {
    ...
    const {handleHomePageOpen, handleAuthOpen, handleProfileOpen, handleChallengesOpen} = useNavigationHandlers();
    ...
    return <HeaderStyled align={'center'}>
        ...
        <UnAuthProtected>
            <MenuItemStyled active={location.pathname === '/auth'} clickable onClick={handleAuthOpen}>
                Login
            </MenuItemStyled>
        </UnAuthProtected>
        <AuthProtected>
